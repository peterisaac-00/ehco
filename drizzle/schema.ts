...
export const users = mysqlTable("users", {
  ...
  /** Account-wide output language for UI preference and newly generated learning content. */
...
/** Local username/password credentials are isolated from the core user profile. */
